...
| [ADR-002: Monorepo structure](./decisions/002-monorepo-structure.md) | pnpm workspace layout and package boundaries |
| [ADR-003: Backend & hosting](./decisions/003-backend-hosting.md) | Hosting, auth, database — options and recommended v1 stack |
